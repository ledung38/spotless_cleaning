...
export const Banner = ({
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden overflow-hidden bg-gradient-to-br from-primary/5 via-blue-50/30 to-accent/10 flex items-center">
      <motion.div
